...
const CardGlare = ({ glare, isHovering }: CardGlareProps) => (
  ...
  <div
    className={`absolute inset-0 pointer-events-none bg-glare-effect mix-blend-screen ${isHovering ? "" : "transition-transform duration-300 ease-[cubic-bezier(.2,.9,.2,1)]"}`}
    style={{
