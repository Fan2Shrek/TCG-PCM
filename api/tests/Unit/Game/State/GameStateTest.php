...
final class GameStateTest extends TestCase
{
    public function testGetPlayer(): void
    {
        ...
        $gameState = new GameState($player1, $player2, 0, 0);
    ...
    public function testGetCurrentPlayerStateWithOtherPlayerTurn()
    {
        $player1 = $this->createPlayerState('1', 'Player 1', 1);
        $player2 = $this->createPlayerState('2', 'Player 2', 1);
        $gameState = new GameState($player1, $player2, 0, 0, '2');
    ...
    {
        $gameState = new GameState($this->createPlayerState('1', 'Player 1', 1), $this->createPlayerState('2', 'Player 2', 1), 0, 0);
    ...
    {
        $gameState = new GameState($this->createPlayerState('1', 'Player 1', 0), $this->createPlayerState('2', 'Player 2', 1), 0, 0);
    ...
    {
        $gameState = new GameState($this->createPlayerState('1', 'Player 1', 1), $this->createPlayerState('2', 'Player 2', 0), 0, 0);
    ...
    public function testWithUpdatedPlayerUpdatePlayer1()
    {
        ...
        $newGameState = $gameState->withUpdatedPlayer(new PlayerState(new Player('1', 'Player 1'), 0, 0, '', [], [], 0, new PlayArea()));
    ...
    public function testWithUpdatedPlayerUpdatePlayer2()
    {
        ...
        $newGameState = $gameState->withUpdatedPlayer(new PlayerState(new Player('2', 'Player 2'), 0, 0, '', [], [], 0, new PlayArea()));
    ...
    public function testWithUpdatedPlayerUnknowPlayer()
    {
        ...
        $gameState->withUpdatedPlayer(new PlayerState(new Player('3', 'Player 3'), 0, 0, '', [], [], 0, new PlayArea()));
    }
    ...
    public function testAddCard()
    {
        ...
        $newState = $gameState->addCard(new CardState('card1', 'Card 1', 'player1'));
    ...
    public function testWithUpdatedCardState()
    {
        ...
        $gameState = $gameState->addCard(new CardState('card1', 'Card 1', 'player1'));

        $newState = $gameState->withUpdatedCardState(new CardState('card1', 'Card 1', 'player1', [CardEffectEnum::HACKED]));
